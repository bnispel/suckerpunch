...
const CHAR_KEYS = ['Blue', 'Green', 'Fire', 'Cape', 'Storm', 'Mike', 'Sticky'];
const CHARACTERS = {
  ...
  Sticky: { name: 'Sticky',        body: '#111111', visor: '#111111', tongue: '#111111', accent: '#cfcfcf', attack: 'stick', stickman: true, power: 'Sticks' },
};
...
function makeFighter(x, y, facing, charKey, combat) {
  ...
  return {
    ...
    ranged: c.attack === 'triangle' || c.attack === 'fireball' || c.attack === 'stick',
    ...
    stickman: c.stickman || false,    // all-black stick figure that throws sticks (Sticky)
    hp: 100, maxHp: 100,
